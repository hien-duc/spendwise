...
//   process.env.API_URL = "http://localhost:3000:3000";
...
async function testAPI() {
  try {
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/financial-goals`,
      {
        method: "POST",
        headers,
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/financial-goals/${financialGoal.id}`,
      {
        method: "PUT",
        headers,
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/fixed-costs/${fixedCost.id}`,
      {
        method: "DELETE",
        headers,
      }
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/periodic-income`,
      {
        method: "POST",
        headers,
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/periodic-income/${periodicIncome.id}`,
      {
        method: "DELETE",
        headers,
      }
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/fixed-investments`,
      {
        method: "POST",
        headers,
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/fixed-investments/${fixedInvestment.id}`,
      {
        method: "DELETE",
        headers,
      }
    ...
    response = await fetch(
      `${process.env.API_URL}/api/financial/generate-transactions`,
      {
        method: "POST",
        headers,
      }
    ...
    response = await fetch(
      `${process.env.API_URL}/api/categories/${category.id}`,
      {
        method: "DELETE",
        headers,
      }
